...
def index():
	...
	if form_1.validate_on_submit():
		student_data = db.session.quest(Detail_Info).select_from(Student).filter_by(name=form_1.name_query.data).join(Detail_Info, Student.student_number==Detail_Info.student_number)
